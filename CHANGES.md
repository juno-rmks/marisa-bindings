...
- Switched to vendored SWIG-generated binding sources to remove build-time SWIG dependency.
...
- Removed runtime reliance on system SWIG during `wheel/sdist builds`.
